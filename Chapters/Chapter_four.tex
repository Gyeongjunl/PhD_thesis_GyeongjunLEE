...
\section{First observations in Non-encapsuated W$S_2$} % (fold)
...
\subsection{Optical Quality Comparison with Non-encapsulated Samples}
\label{subsec:Optical Quality Comparison with Non-encapsulated Samples}




\section{Thermal Activation of Defect Emission in hBN Encapsulated WS$_2$} % (fold)
