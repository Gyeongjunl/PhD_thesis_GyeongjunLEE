...
Fig.~\ref{fig:linewidth_xd}(b) shows a zoomed PL spectrum of $X_D$. Lorentzian fitting yields a sub-meV FWHM of $\approx 0.218$~meV, close to the instrumental spectral resolution of the spectrometer, and more than an order of magnitude narrower than the $X_L$ linewidth of $\sim$3~meV. The evolution of this linewidth as a function of excitation power will be examined in the following section.
