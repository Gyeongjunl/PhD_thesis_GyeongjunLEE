...
\newcommand{\PhDTitle}{Controlled creation of single-photon emitters in 2D semiconductors} 	%% Titre de la thèse / Thesis title
\newcommand{\PhDname}{Gyeongjun LEE} 															%% Civilité, nom et prénom /  Civility, first name and name 
\newcommand{\NNT}{213066640GJ} 															%% Numéro National de Thèse (donnée par la bibliothèque à la suite du 1er dépôt)/ National Thesis Number (given by the Library after the first deposit)
...
\newcommand{\PhDworkingplace}{
	Laboratoire de Physique de la Matière Condensée, Ecole polytechnique} 										%% Établissement de préparation / PhD working place :  l'École polytechnique, l'École nationale supérieure de techniques avancées, l'École nationale de la statistique et de l’administration économique, Télécom ParisTech, Télécom SudParis, l’École des hautes études commerciales de Paris   
\newcommand{\defenseplace}{Palaiseau} 											%% Ville de soutenance / Place of defense
\newcommand{\defensedate}{15/09/2024} 															%% Date de soutenance / Date of defense
...
\newcommand{\jurynameD}{Julien Chaste}
\newcommand{\juryadressD}{Chargé de Recherche, Centre de Nanosciences et de Nanotechnologies (C2N), CNRS (UMR 9001)/Université Paris-Saclay, Palaiseau, France}
\newcommand{\juryroleD}{Examinateur}

%%% Membre n°5 (Directeur de thèse) / Member n°5 (Thesis supervisor)
\newcommand{\jurynameE}{Fabian Cadiz}
\newcommand{\juryadressE}{Professeur, Laboratoire de Physique de la Matière Condensée (PMC), École polytechnique, Palaiseau, France}
\newcommand{\juryroleE}{Directeur de thèse}

%%% Membre n°6 (Co-directeur de thèse) / Member n°6 (Thesis co-supervisor)
\newcommand{\jurynameF}{Fausto Sirotti}
\newcommand{\juryadressF}{Directeur de Recherche, Laboratoire de Physique de la Matière
Condensée (PMC), CNRS (UMR 7643)/Ecole polytechnique, Directeur de thèse, Palaiseau, France}
\newcommand{\juryroleF}{Co-directeur de thèse}

%%% Membre n°7 (Invité) / Member n°7 (Guest)
\newcommand{\jurynameG}{Alistair Rowe}
\newcommand{\juryadressG}{Chargé de Recherche, Laboratoire de Physique de la Matière Condensée(PMC), CNRS (UMR 7643)/Ecole polytechnique, Palaiseau, France}
